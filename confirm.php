...
window.onclick = function(event) {
  if (!event.target.matches('.dropbtn')) {
	...
	<center><button id="button"><a href="get data1.php">RECENT CUSTOMERS</a></button></center><br>
<?php
$Name=$_POST['sname'];
$Email =$_POST['smail'];
$Mobile=$_POST['snum'];
...
if($con){
	...
	<center><?php echo "THANKS"?></center>
	<?php
	$insert="insert into message(name,email,mobile,message)values('$Name','$Email','$Mobile','$Message')";
