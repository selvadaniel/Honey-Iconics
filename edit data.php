...
if($con){
	...
	$id=$_GET['id'];
    $fetch="select * from honey where id=$id";
...
window.onclick = function(event) {
  if (!event.target.matches('.dropbtn')) {
	...
	<form method="POST" action="edit save.php">
		...
		<center><label><b><h3>Name </b></label><input type="text" value="<?php echo $convert['name'];?>"name="myname" required></h3><br></center>
	    <center><label><b><h3>Email  </b></label><input type="text" value="<?php echo $convert['email']; ?>" name="myemail"required></h3><br></center>
		<center><label><b><h3>Number   </b></label><input type="int" value="<?php echo $convert['mobile'] ;?>"name="myphone"required></h3><br></center>
		<center><label><b><h3> Address   </b> </label><input type="text" value="<?php echo $convert['address']; ?>"name="myadd"required></h3><br></center>
		<center><label><b><h3>Position   </b> </label><input type="text" value="<?php echo $convert['position']; ?>"name="mypos"required></h3><br></center>
		<center><label><b><h3>Experience  </b> </label><input type="text" value="<?php echo $convert['experience']; ?>"name="myex"required></h3><br></center>
		<center><label><b><h3> Resume link  </b> </label><input type="link" value="<?php echo $convert['resumelink']; ?>"name="mylink"required></h3><br><br></center>
