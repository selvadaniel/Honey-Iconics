	...
	while($convert=mysqli_fetch_assoc($result))
	{
		...
		?>
					...
					<tr>
						...
						<td><?php echo $convert["position"] ?></td>
						<td><?php echo $convert["experience"] ?></td>
						<td><?php echo $convert["resumelink"] ?></td>
						<td><center><a href="edit data.php?id=<?php echo $convert['id']?>"><button id="button">edit</button></a>
						<a href="delete.php?id=<?php echo $convert['id']?>"><button id="button">delete</button></a></center></td>
